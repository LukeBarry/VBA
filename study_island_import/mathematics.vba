...
' select math sheet and delete unnecessary columns
Sheets("math").Select
    Columns("A:B").Select
...
' filter course column to just the classes we want to import
    ...
    ActiveSheet.Range("$I$1:$I$15000").AutoFilter Field:=1, Criteria1:=Array( _
        "Algebra I", "Algebra I LS", "CR Algebra I", "Mathematics 3", "Mathematics 3 LS", _
        "Mathematics 4", "Mathematics 4 LS", "Mathematics 5", "Mathematics 5 LS", "Mathematics 6", "Mathematics 6 LS", _
        "Mathematics 7", "Mathematics 7 LS", "Mathematics 8", "Mathematics 8 LS"), Operator:=xlFilterValues
...
' sort by SIS Primary key and then use an if then statement to identify duplicate primary keys and move them to another sheet
    Cells.Select
    ActiveWorkbook.Worksheets("math").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("math").Sort.SortFields.Add Key:=Range("A2:A15000") _
        , SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
    With ActiveWorkbook.Worksheets("math").Sort
    ...
    ActiveWorkbook.Worksheets("math").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("math").Sort.SortFields.Add Key:=Range("B2:B15000") _
...
' filter cut and paste the duplicates to the duplicate sheet
    ...
    Cells.Select
    ActiveWorkbook.Worksheets("math").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("math").Sort.SortFields.Add Key:=Range("J2:J15000"), _
        SortOn:=xlSortOnValues, Order:=xlDescending, DataOption:=xlSortNormal
    With ActiveWorkbook.Worksheets("math").Sort
