...
' select eng sheet and delete unnecessary columns
Sheets("eng").Select
    Columns("A:B").Select
...
' filter course column to just the classes we want to import
    ...
    ActiveSheet.Range("$I$1:$I$15000").AutoFilter Field:=1, Criteria1:=Array( _
        "English 10", "English 10 LS", "English 7", "English 7 LS", "English 8", _
        "English 8 LS", "English 9", "English 9 LS", "Language Arts 3", _
        "Language Arts 3 LS", "Language Arts 4", "Language Arts 4 LS", "Language Arts 5", _
        "Language Arts 5 LS", "Language Arts 6", "Language Arts 6 LS", "Reading 3", _
        "Reading 4", "Reading 5"), Operator:=xlFilterValues
...
' sort by SIS Primary key and then use an if then statement to identify duplicate primary keys and move them to another sheet
    Cells.Select
    ActiveWorkbook.Worksheets("eng").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("eng").Sort.SortFields.Add Key:=Range("A2:A15000") _
        , SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
    With ActiveWorkbook.Worksheets("eng").Sort
    ...
    ActiveWorkbook.Worksheets("eng").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("eng").Sort.SortFields.Add Key:=Range("B2:B15000") _
...
' filter cut and paste the duplicates to the duplicate sheet
    ...
    Cells.Select
    ActiveWorkbook.Worksheets("eng").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("eng").Sort.SortFields.Add Key:=Range("J2:J15000"), _
        SortOn:=xlSortOnValues, Order:=xlDescending, DataOption:=xlSortNormal
    With ActiveWorkbook.Worksheets("eng").Sort
